...
export default function ProductsPage() {
  ...
  const [formData, setFormData] = useState({ name: "", description: "", model_number: "" });
  ...
  const startEdit = (product) => {
    ...
    setFormData({ name: product.name, description: product.description || "", model_number: product.model_number || "" });
  };
            ...
            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
              <div className="bg-saru-slate p-8 rounded-xl shadow-2xl max-w-md w-full mx-4">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <label className="block text-saru-cyan mb-2">Model Number</label>
                    <input
                      type="text"
